...
- Basic Canvas MVP controls: select/drag/nudge nodes, grouped node backgrounds with lock/unlock, sidebar and direct wheel/blank-canvas pan/zoom/reset viewport controls, visual handle-to-handle connect, connect selected node to the next node, visual edge removal, undo, and redo
...
- Full editable canvas UX: multi-select, group creation/resizing, and polished drag/handle affordances

...
- Basic Canvas MVP controls: select/drag/nudge nodes, pan/zoom/reset viewport, connect selected node to the next node, handle-level connect/disconnect, remove edges, undo, and redo

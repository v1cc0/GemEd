...
- Basic Canvas MVP controls: select/drag/nudge nodes, connect selected node to the next node, handle-level connect/disconnect, remove edges, undo, and redo
...
- Full editable canvas UX: pan/zoom, multi-select, grouped nodes, and polished drag/handle affordances

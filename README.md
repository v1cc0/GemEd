...
- Basic Canvas MVP controls: select/drag/nudge nodes, pan/zoom/reset viewport, visual handle-to-handle connect, connect selected node to the next node, remove edges, undo, and redo
...
- Full editable canvas UX: wheel/gesture zoom, multi-select, grouped nodes, visual disconnect gestures, and polished drag/handle affordances
